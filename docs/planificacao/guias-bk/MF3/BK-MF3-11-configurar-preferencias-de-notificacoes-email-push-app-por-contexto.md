...
- Backend: `real_dev/api/src/modules/notification-preferences`.
- Frontend: `real_dev/web/src/features/notification-preferences`.
...
- CRIAR: `real_dev/api/src/modules/notification-preferences/dto/update-notification-preferences.dto.ts`
- CRIAR: `real_dev/api/src/modules/notification-preferences/schemas/notification-preference.schema.ts`
- CRIAR: `real_dev/api/src/modules/notification-preferences/notification-preferences.service.ts`
- CRIAR: `real_dev/api/src/modules/notification-preferences/notification-preferences.controller.ts`
- CRIAR: `real_dev/api/src/modules/notification-preferences/notification-preferences.module.ts`
- CRIAR: `real_dev/web/src/features/notification-preferences/update-notification-preferences.ts`
- CRIAR: `real_dev/web/src/features/notification-preferences/notification-preferences-panel.tsx`
...
```ts
// real_dev/api/src/modules/notification-preferences/dto/update-notification-preferences.dto.ts
...
```ts
// real_dev/api/src/modules/notification-preferences/schemas/notification-preference.schema.ts
...
```ts
// real_dev/api/src/modules/notification-preferences/notification-preferences.module.ts
