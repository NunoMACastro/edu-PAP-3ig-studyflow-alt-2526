# BK-MF8-09 - Interface em português (Portugal).
...
## Contexto do BK
- Entrega alvo: `Interface em português (Portugal).` com rastreabilidade direta para `RNF42`.
...
- [ ] Sei explicar como `RNF42` se traduz em comportamento implementável.
