...
- [ ] Sei explicar como `RNF37` se traduz em comportamento implementável.
...
### Passos
1. Confirmar no backlog e na matriz o escopo de `BK-MF8-04` e do requisito `RNF37`.
...
export async function registarAluno(input: Credenciais) {
  ...
  return { bkId: 'BK-MF8-04', req: 'RNF37', estado: 'REGISTADO' };
}
```

Garante validação mínima de identidade no arranque do fluxo de conta.
- Requisitos alvo deste BK: `RNF37`.
