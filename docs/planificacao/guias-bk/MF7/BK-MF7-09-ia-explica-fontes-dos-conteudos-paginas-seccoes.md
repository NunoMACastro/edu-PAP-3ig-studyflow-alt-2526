...
- [ ] Sei explicar como `RNF31` se traduz em comportamento implementável.
...
export async function registarAluno(input: Credenciais) {
  ...
  return { bkId: 'BK-MF7-09', req: 'RNF31', estado: 'REGISTADO' };
}
```

Garante validação mínima de identidade no arranque do fluxo de conta.
- Requisitos alvo deste BK: `RNF31`.
