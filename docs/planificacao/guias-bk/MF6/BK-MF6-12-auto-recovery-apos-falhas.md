...
## Contexto do BK
- Entrega alvo: `Auto-recovery após falhas.` com rastreabilidade direta para `RNF22`.
...
- [ ] Sei explicar como `RNF22` se traduz em comportamento implementável.
...
### Passos
1. Confirmar no backlog e na matriz o escopo de `BK-MF6-12` e do requisito `RNF22`.
