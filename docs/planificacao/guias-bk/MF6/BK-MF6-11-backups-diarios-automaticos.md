...
## Contexto do BK
- Entrega alvo: `Backups diários automáticos.` com rastreabilidade direta para `RNF21`.
...
- [ ] Sei explicar como `RNF21` se traduz em comportamento implementável.
...
### Passos
1. Confirmar no backlog e na matriz o escopo de `BK-MF6-11` e do requisito `RNF21`.
