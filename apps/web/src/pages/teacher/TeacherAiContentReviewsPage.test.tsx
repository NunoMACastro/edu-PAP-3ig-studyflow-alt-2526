...
describe("TeacherAiContentReviewsPage", () => {
    it("mostra a fila por material e aprova com comentário sem JSON ou ids", async () => {
        ...
        const dialog = screen.getByRole("dialog", { name: "Resumo para aprovação" });
    ...
    it("usa um seletor de materiais processados na criação", async () => {
        ...
        await user.click(screen.getByRole("button", { name: "Novo conteúdo" }));
        const dialog = screen.getByRole("dialog", { name: "Criar conteúdo docente" });
