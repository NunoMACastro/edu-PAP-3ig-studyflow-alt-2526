...
describe("TeacherDashboardPage", () => {
    it("renderiza métricas, badges e detalhes de disciplinas com singular/plural", async () => {
        ...
        expect(screen.getByRole("link", { name: "Conteúdos aprovados de Matemática" })).toBeTruthy();
        expect(
            screen.getByRole("link", {
                name: "Centro de Acompanhamento de Turma Completa",
            }).getAttribute("href"),
        ).toBe("/app/professor/acompanhamento?classId=class-rich");
        expect(screen.queryByRole("link", { name: "Abrir sinais a rever" })).toBeNull();
