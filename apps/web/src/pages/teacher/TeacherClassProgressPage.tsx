    ...
    return (
        <section className="space-y-4">
            ...
            <div className="sf-panel space-y-2">
                <div className="rounded-md border border-studyflow-alert bg-studyflow-card px-3 py-2 text-sm text-studyflow-alertText">
            ...
            <form className="sf-panel space-y-3" id="criar-nota-progresso" onSubmit={handleSubmit}>
                ...
                <label className="block space-y-2">
                    ...
                    <input
                        aria-describedby="progress-difficulties-help"
                        className="sf-input"
                        value={difficultyTags}
                        onChange={(event) => setDifficultyTags(event.target.value)}
                    />
                </label>
                <p className="text-xs text-studyflow-text" id="progress-difficulties-help">
                    Separa várias dificuldades por vírgulas.
                </p>
