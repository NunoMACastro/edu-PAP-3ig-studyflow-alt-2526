...
export function TeacherOfficialTestsPage({ subjectId }: { subjectId: string }) {
    ...
    return (
        <section className="grid gap-6 xl:grid-cols-[minmax(0,520px)_1fr]">
            <form
                className="sf-surface space-y-5"
                id="criar-teste"
            ...
            >
                ...
                <div className="space-y-4">
                    {questions.map((question, questionIndex) => (
                        <fieldset
                            className="space-y-3 rounded-xl border border-studyflow-border/10 bg-studyflow-page/35 p-4"
                            key={questionIndex}
                        >
            ...
            <div className="grid content-start gap-3">
                {loading ? (
                    <p className="sf-notice text-sm" aria-live="polite">
                        A carregar testes...
                    </p>
                ) : null}
                ...
                {tests.map((test) => {
                    ...
                    return (
                        <article className="sf-list-card space-y-3" key={test._id}>
