...
export function StudentApprovedAiContentPage({ subjectId }: { subjectId: string }) {
    ...
    return (
        <section className="space-y-6">
            <PageHeader
                description="Resumos e quizzes revistos pelo professor da disciplina."
                title="Conteúdos IA aprovados"
            />
                        ...
                        <article className="sf-surface space-y-4" key={item.reviewId}>
                            <div className="flex flex-wrap items-start justify-between gap-3">
                                <div>
                                    ...
                                    <p className="mt-1 text-sm text-studyflow-text/60">Aprovado em {formatDatePt(item.approvedAt)}</p>
                                </div>
