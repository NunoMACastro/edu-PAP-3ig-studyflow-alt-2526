                                ...
                                <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
                                    {areas.map((area) => (
                                        <ContextCard
                                            ...
                                            description={area.description ?? "Espaço pessoal para materiais e ferramentas de estudo."}
                                            href={`/app/areas/${area._id}`}
                                            key={area._id}
                                            meta={<div className="flex flex-wrap gap-2"><StatusBadge>Criada por ti</StatusBadge><StatusBadge>Privada</StatusBadge></div>}
                                            title={area.name}
                                        />
                                    ))}
                                </div>
