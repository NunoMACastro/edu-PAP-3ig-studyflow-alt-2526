...
describe("RoutinesPage", () => {
    ...
    it("cria, edita, conclui/reabre e arquiva objetivos", async () => {
        ...
        await user.type(screen.getByLabelText("Descrição"), "Descrição da meta");
        fireEvent.change(screen.getByLabelText("Data alvo"), { target: { value: "2026-08-01" } });
        ...
        expect((screen.getByLabelText("Data alvo") as HTMLInputElement).value).toBe("2026-07-20");
