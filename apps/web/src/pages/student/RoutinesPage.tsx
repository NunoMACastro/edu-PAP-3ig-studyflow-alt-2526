...
import { formatStudyWeekdaysPt } from "../../lib/format-weekdays-pt.js";
                        ...
                        {data.routines.map((routine) => (
                            <li className="sf-list-card text-sm" key={routine._id}>
                                <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                                    <div><p className="font-semibold">{routine.title}</p><p className="mt-1 text-studyflow-text/65">{formatStudyWeekdaysPt(routine.weekdays)} às {routine.startTime}, {routine.durationMinutes} min</p></div>
