        ...
        <section className="space-y-8">
            ...
            <div className="grid gap-6 xl:grid-cols-2">
                <section className="sf-section-group space-y-4">
                    <SectionHeader description="Dias, hora e duração dos blocos de estudo." title="Rotinas de estudo" />
                ...
                <section className="sf-section-group space-y-4">
                    <SectionHeader description="Metas pessoais e respetivo estado de conclusão." title="Objetivos" />
