                ...
                {subjects.map((subject) => (
                    <article className="sf-panel space-y-2" key={subject._id}>
                        ...
                        <div className="flex flex-wrap gap-2">
                            ...
                            <a className="sf-button-secondary gap-2" href={`/app/disciplinas/${subject._id}/chat`}>
                            ...
                            <a className="sf-button-secondary" href={`/app/disciplinas/${subject._id}/contextos-materiais`}>Contextos</a>
                        </div>
                    </article>
                ))}
            </div>
