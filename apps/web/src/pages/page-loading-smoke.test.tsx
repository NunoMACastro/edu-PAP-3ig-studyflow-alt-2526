...
const cases: RouteCase[] = [
    ...
    { name: "conteúdos IA aprovados", element: <StudentApprovedAiContentPage subjectId="subject-id" />, expectedText: /conteúdos IA aprovados/i },
    { name: "chat do aluno", element: <StudentSubjectChatPage subjectId="subject-id" />, expectedText: /chat da disciplina/i },
