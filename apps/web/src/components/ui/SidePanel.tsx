    ...
    return createPortal(
        ...
        >
            <section
                ...
                aria-modal="true"
                className="flex h-dvh w-full max-w-[440px] flex-col border-l border-studyflow-border/15 bg-studyflow-card shadow-2xl outline-none motion-safe:animate-[sf-slide-in_180ms_ease-out]"
                role="dialog"
                tabIndex={-1}
            >
