...
import { MarkdownFileActions } from "../markdown/MarkdownFileActions.js";
        ...
        <div className="space-y-3">
            ...
            <ul className="space-y-3">
                {materials.map((material) => {
                    ...
                    return (
                        <li className="rounded-xl border border-studyflow-border/10 bg-studyflow-page/35 bg-studyflow-card p-4" key={material._id}>
                            ...
                            <div className="mt-3 flex flex-wrap gap-2">
                                {material.type === "MARKDOWN" ? (
                                    <MarkdownFileActions
                                        downloadHref={`/api/study-areas/${studyAreaId}/materials/${material._id}/download`}
                                        editTo={`/app/areas/${studyAreaId}/materiais/${material._id}?edit=1`}
                                        viewTo={`/app/areas/${studyAreaId}/materiais/${material._id}`}
                                    />
                                ) : (
                                    <button
...
function materialTypeLabel(type: StudyMaterial["type"]): string {
    ...
    if (type === "MARKDOWN") return "Documento Markdown";
    return type;
}
