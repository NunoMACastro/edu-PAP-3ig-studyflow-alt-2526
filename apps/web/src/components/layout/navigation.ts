...
const navigationItems: NavigationItem[] = [
    { href: "/app/hoje", icon: "home", label: "Hoje", roles: ["STUDENT"] },
    { href: "/app/estudar", icon: "book", label: "Estudar", roles: ["STUDENT"] },
    { href: "/app/em-grupo", icon: "users", label: "Em grupo", roles: ["STUDENT"] },
    { href: "/app/plano", icon: "calendar", label: "Plano", roles: ["STUDENT"] },
...
export function isNavigationItemActive(
    ...
    const isRoleLandingPath = pathname === "/" || pathname === "/app" || pathname === "/app/hoje";

    if (item.href === "/app/hoje") {
        return isRoleLandingPath;
    }

    if (item.href === "/app/estudar") {
        return pathname === item.href || pathname.startsWith("/app/turmas/") || pathname.startsWith("/app/disciplinas/") || pathname.startsWith("/app/areas/");
    }

    if (item.href === "/app/em-grupo") {
        return pathname === item.href || pathname.startsWith("/app/grupos/") || pathname.startsWith("/app/salas/");
    }
