...
describe("primitivos visuais acessíveis", () => {
    ...
    it("renderiza toda a iconografia permitida e posiciona tooltips sem depender do viewport", () => {
        const names: ShellIconName[] = [
            "arrowRight", "bell", "book", "calendar", "chart", "check", "clipboard",
            "download", "externalLink", "file", "folder", "graduation", "history", "home", "help", "info",
            "lock", "logOut", "menu", "megaphone", "message", "play", "plus", "shield",
