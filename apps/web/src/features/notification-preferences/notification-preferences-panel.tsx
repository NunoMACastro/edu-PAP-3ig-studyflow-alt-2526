...
export function NotificationPreferencesPanel() {
     ...
     *
     * @param preference preference necessário para executar toggle sem depender de estado global.
     * @param field field necessário para executar toggle sem depender de estado global.
     */
