...
export function FollowUpAlertsPanel() {
    ...
    /**
     * Cria a ação de interface ligada a alertas de acompanhamento, sincronizando dados remotos, estado local e mensagens visíveis ao utilizador.
     *
     * @returns Não devolve payload; termina quando os efeitos locais ou remotos ficam concluídos.
     */
    ...
    /**
     * Notifica notify task para alertas de acompanhamento, escondendo os detalhes técnicos atrás de uma API simples para a interface.
     *
     * @returns Não devolve payload; termina quando os efeitos locais ou remotos ficam concluídos.
     */
