...
const toneClasses: Record<FeedbackTone, string> = {
    loading: "border-studyflow-brandText bg-studyflow-card text-studyflow-brandText",
    success: "border-studyflow-brandText bg-studyflow-card text-studyflow-brandText",
    error: "border-studyflow-alert bg-studyflow-alert text-studyflow-alertText",
};
    ...
    return (
        <ActionFeedbackContext.Provider value={value}>
            ...
            {feedback ? (
                ...
                >
                    <div
                        className={`rounded-2xl border p-4 text-sm shadow-2xl backdrop-blur-xl ${toneClasses[feedback.tone]}`}
                    >
