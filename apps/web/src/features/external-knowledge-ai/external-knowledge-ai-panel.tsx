...
export function ExternalKnowledgeAiPanel() {
    ...
    return (
        <section className="sf-surface space-y-4" aria-labelledby="external-knowledge-title">
            <header>
            ...
            <form className="space-y-3" onSubmit={(event) => void handleSubmit(event)}>
                ...
                <label className="flex items-start gap-2 text-sm" htmlFor="external-knowledge-consent">
                    <input
                        id="external-knowledge-consent"
                        type="checkbox"
            ...
            {!answer && !loading && !submitAction.error ? (
                <p className="text-sm text-studyflow-text">
