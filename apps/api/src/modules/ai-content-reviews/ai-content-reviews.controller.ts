...
export class AiContentReviewsController {
    ...
    /**
     * Lista apenas conteúdos aprovados para um aluno inscrito na disciplina.
     */
    @Get("student/subjects/:subjectId/approved-ai-content")
    listApprovedForStudent(
        @Req() request: AuthenticatedRequest,
        @Param("subjectId") subjectId: string,
    ) {
        return this.reviewsService.listApprovedForStudent(
            request.user!,
            subjectId,
        );
    }
    ...
    /**
     * Corrige e persiste uma tentativa num quiz aprovado.
     */
    @Post("student/subjects/:subjectId/approved-ai-content/:reviewId/quiz-attempts")
    submitApprovedQuizAttempt(
        @Req() request: AuthenticatedRequest,
        @Param("subjectId") subjectId: string,
        @Param("reviewId") reviewId: string,
        @Body() body: SubmitApprovedAiQuizAttemptDto,
    ) {
        return this.reviewsService.submitApprovedQuizAttempt(
            request.user!,
            subjectId,
            reviewId,
            body,
    ...
    /** Lista o histórico próprio de tentativas sem expor soluções do quiz. */
    @Get("student/subjects/:subjectId/approved-ai-content/:reviewId/quiz-attempts")
    listApprovedQuizAttempts(
        @Req() request: AuthenticatedRequest,
        @Param("subjectId") subjectId: string,
        @Param("reviewId") reviewId: string,
    ) {
        return this.reviewsService.listApprovedQuizAttempts(
            request.user!,
            subjectId,
            reviewId,
        );
