...
export class AiContentReviewsService {
    ...
    async listApprovedForStudent(
        ...
        return reviews.flatMap((review) => {
            ...
            return material ? [this.toStudentView(review, material)] : [];
        });
    }
