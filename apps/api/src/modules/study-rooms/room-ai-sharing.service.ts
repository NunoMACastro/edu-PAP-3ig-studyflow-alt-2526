...
type RoomAiPersisted = {
    ...
    sharedAt?: Date;
    forkedFromInteractionId?: unknown;
    createdAt?: Date;
};
...
export class RoomAiSharingService {
     ...
     * @throws BadRequestException quando o identificador não é um ObjectId válido.
     */
     ...
     * @throws BadRequestException quando o modo não pertence ao contrato público.
     */
    ...
    private toAnswerView(answer: RoomAiPersisted): RoomAiAnswerReuseView {
        return {
            ...
            visibility: answer.visibility ?? "PRIVATE",
