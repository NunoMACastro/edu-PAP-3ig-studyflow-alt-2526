...
/**
 * Vista pública do job de quiz para polling da UI.
 */
...
/**
 * Forma lean esperada ao converter documentos internos em contratos públicos.
 */
...
/**
 * Service de jobs de quiz em background.
 */
@Injectable()
export class QuizGenerationJobsService {
    ...
    /**
     * Recebe persistência e service canónico de ferramentas de estudo por injeção.
     *
     * @param jobModel Modelo Mongoose de jobs de quiz.
     * @param studyToolsService Porta para validação de fontes e geração real de quiz.
     */
    constructor(
    ...
    async createQuizJob(
        ...
        // A pré-validação confirmou ownership/fontes; a geração pesada continua fora da resposta HTTP.
