 ...
 *
 * @param content Valor de content usado pela função para executar validate quiz artifact com dados explícitos.
 * @param allowedSourceIds Identificador usado para localizar o recurso correto e validar o acesso ao seu âmbito.
...
export function validateQuizArtifact(
    ...
    for (const rawQuestion of questions as QuizQuestion[]) {
        ...
        if (
            ...
            (!allowEmptySources && rawQuestion.sourceMaterialIds.length === 0) ||
