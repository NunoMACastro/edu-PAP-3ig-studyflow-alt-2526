...
describe("AiAreaProfileService", () => {
     ...
     *
     * @param overrides overrides necessário para executar make material sem depender de estado global.
     ...
     * @param processableSources processable sources necessário para executar make service sem depender de estado global.
     * @returns Valor de artefactos de IA no contrato esperado pelo chamador.
     */
