...
describe("AiGuardrailsService", () => {
    ...
    it("bloqueia pedido sem finalidade pedagógica", async () => {
...
function makeService() {
    const checkModel = {
        create: jest.fn().mockImplementation(async (input) => ({
            ...
            ...input,
            /**
             * Transforma o apoio de teste para guardrails de IA, mantendo o cenário legível e próximo do comportamento real validado.
             * Este fluxo mantém a governação de IA explícita quando depende de consentimento, política, quota ou fontes autorizadas.
             *
