...
export const PERSONAL_DATA_REGISTRY_VERSION = "2026-07-10.1";
...
export const PERSONAL_DATA_REGISTRY: readonly RegistryRule[] = [
    ...
    direct("ClassAiInteraction", ["studentId"]),
    direct("ProjectAiPlan", ["studentId"]),
    ...
    direct("ContextNotification", ["actorId"], "DELETE", [
        "recipientIds",
