...
describe("PersonalDataRegistryService", () => {
    ...
    it("gera attachment por stream sem hashes, internals ou IDs de terceiros", async () => {
        ...
        for (const modelName of [
            ...
            const exportedInteraction = collections[modelName][0];
            ...
            expect(JSON.stringify(exportedInteraction)).not.toContain(
                `teacher-voice-rule-${modelName}-never-export`,
            );
        }
        ...
        ClassAiInteraction: [
            {
                ...
                question: "Pergunta própria",
                answer: "Resposta própria",
                voiceSource: "SUBJECT_OVERRIDE",
                voiceTone: "DIRECT",
                voiceDetailLevel: "DETAILED",
                voiceRulesApplied: [
                    "teacher-voice-rule-ClassAiInteraction-never-export",
                ],
            },
        ],
        GuidedStudyRoomAiInteraction: [
            {
                _id: new Types.ObjectId(),
                studentId: new Types.ObjectId(userId),
                question: "Pergunta própria guiada",
                answer: "Resposta própria guiada",
                voiceSource: "SUBJECT_OVERRIDE",
                voiceTone: "DIRECT",
                voiceDetailLevel: "DETAILED",
                voiceRulesApplied: [
                    "teacher-voice-rule-GuidedStudyRoomAiInteraction-never-export",
                ],
            },
        ],
        ProjectAiPlan: [
            {
                _id: new Types.ObjectId(),
                studentId: new Types.ObjectId(userId),
                studentGoal: "Objetivo próprio",
                steps: ["Passo próprio"],
                voiceSource: "CLASS_BASE",
                voiceTone: "SOCRATIC",
                voiceDetailLevel: "BALANCED",
                voiceRulesApplied: [
                    "teacher-voice-rule-ProjectAiPlan-never-export",
                ],
            },
        ],
    };
