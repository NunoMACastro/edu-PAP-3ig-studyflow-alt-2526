 ...
 */
export type OfficialMaterialType = "TEXT" | "URL" | "PDF" | "DOCX" | "MARKDOWN";
/**
...
export class OfficialMaterial {
    ...
    @Prop({ required: true, enum: ["TEXT", "URL", "PDF", "DOCX", "MARKDOWN"] })
    type!: OfficialMaterialType;

    @Prop({
        required: true,
        enum: ["PROCESSED", "REFERENCE_ONLY", "PENDING_PROCESSING", "DRAFT"],
    })
