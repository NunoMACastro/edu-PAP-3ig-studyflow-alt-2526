...
export class OfficialMaterialsController {
    ...
    /** Devolve detalhe docente, incluindo a fonte de um rascunho Markdown. */
    @Get(":materialId")
    get(
        @Req() request: AuthenticatedRequest,
        @Param("subjectId") subjectId: string,
        ...
        return this.materialsService.getTeacherSubjectMaterial(
            request.user!,
            subjectId,
            materialId,
        );
    ...
    /** Guarda Markdown oficial com precondição de revisão. */
    @Patch(":materialId/markdown")
    updateMarkdown(
        @Req() request: AuthenticatedRequest,
        @Param("subjectId") subjectId: string,
        @Param("materialId") materialId: string,
        @Body() body: UpdateOfficialMarkdownDto,
    ) {
        return this.materialsService.updateOfficialMarkdown(
            request.user!,
            subjectId,
            materialId,
            body,
    ...
    /** Publica pela primeira vez um rascunho Markdown. */
    @Post(":materialId/publish")
    publishMarkdown(
        @Req() request: AuthenticatedRequest,
        @Param("subjectId") subjectId: string,
        @Param("materialId") materialId: string,
        @Body() body: PublishOfficialMarkdownDto,
    ) {
        return this.materialsService.publishOfficialMarkdown(
            request.user!,
            subjectId,
            materialId,
            body,
