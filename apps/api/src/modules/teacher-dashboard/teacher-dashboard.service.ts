...
export class TeacherDashboardService {
    ...
    private async buildClassRow(
        ...
        const [
            ...
            this.guidedStudyRoomsService.countCompletedInOpenRooms(schoolClass._id),
        ]);
    ...
    private toClassRow(
        ...
        return {
            ...
            guidedRoomCompletionsCount: guidedRoomCompletions,
