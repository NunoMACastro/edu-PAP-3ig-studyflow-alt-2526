...
import { MaterialStorageReconciliationService } from "./material-storage-reconciliation.service.js";
...
@Module({
    ...
    providers: [
        ...
        MaterialStorageReconciliationService,
        MaterialUploadRateLimitGuard,
    ],
