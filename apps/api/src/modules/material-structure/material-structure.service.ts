...
export class MaterialStructureService {
     ...
     *
     * @param text text necessário para executar derive title sem depender de estado global.
     * @param order order necessário para executar derive title sem depender de estado global.
     * @returns Valor de estrutura de materiais no contrato esperado pelo chamador.
     */
