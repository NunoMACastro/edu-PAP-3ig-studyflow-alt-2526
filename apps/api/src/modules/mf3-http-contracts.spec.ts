...
async function dispatchJson(
    ...
    const request = Object.assign(
        new Readable({
             ...
             * @returns Valor de mf3 http contracts spec ts no contrato esperado pelo chamador.
             */
            read() {
                this.push(payload);
                this.push(null);
...
function makeSocket() {
    return Object.assign(
        new Duplex({
             ...
             *
             * @param _chunk chunk necessário para executar write sem depender de estado global.
             * @param _encoding encoding necessário para executar write sem depender de estado global.
             * @param callback Callback exigido pela API Node.js para concluir a operação simulada ou customizada.
             * @returns Valor de mf3 http contracts spec ts no contrato esperado pelo chamador.
             */
...
function makeWritableResponse(chunks: Buffer[]) {
    ...
    return Object.assign(
        new Writable({
             ...
             * Executa a operação write no domínio de mf3 http contracts spec ts com contrato explícito.
             *
             * @param chunk chunk necessário para executar write sem depender de estado global.
             * @param _encoding encoding necessário para executar write sem depender de estado global.
             * @param callback Callback exigido pela API Node.js para concluir a operação simulada ou customizada.
             * @returns Valor de mf3 http contracts spec ts no contrato esperado pelo chamador.
             */
        ...
        }),
        {
             ...
             *
             * @param name name necessário para executar set header sem depender de estado global.
             ...
             *
             * @param name name necessário para executar get header sem depender de estado global.
             ...
             *
             * @param name name necessário para executar remove header sem depender de estado global.
             * @returns Valor de mf3 http contracts spec ts no contrato esperado pelo chamador.
             */
             ...
             *
             * @param statusCode status code necessário para executar write head sem depender de estado global.
             * @param nextHeaders next headers necessário para executar write head sem depender de estado global.
             * @returns Valor de mf3 http contracts spec ts no contrato esperado pelo chamador.
             */
