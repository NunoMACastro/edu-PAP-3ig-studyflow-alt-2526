...
import { CreateClassProjectDto, UpdateClassProjectDto, UpdateStudentProjectProgressDto } from "./dto/create-class-project.dto.js";
...
export class ClassProjectsController {
    ...
    @Get("student/class-projects/:projectId")
    getStudentProject(
        @Req() request: AuthenticatedRequest,
        @Param("projectId") projectId: string,
    ) {
        return this.projectsService.getPublishedForStudent(request.user!, projectId);
    }

    @Patch("student/class-projects/:projectId/progress")
    updateStudentProgress(
        @Req() request: AuthenticatedRequest,
        @Param("projectId") projectId: string,
        @Body() body: UpdateStudentProjectProgressDto,
    ) {
        return this.projectsService.updateStudentProgress(
            request.user!,
            projectId,
            body.status,
        );
