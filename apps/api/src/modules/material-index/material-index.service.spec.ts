 ...
 *
 * @param materialOverrides material overrides necessário para executar make service sem depender de estado global.
...
function makeService(
    ...
    const officialMaterialsService = { findOwnedMaterial: jest.fn() };
    ...
    return { jobModel, materialsService, service, subjectsService, documentSafety };
}
