...
describe("StudentProfileService", () => {
    ...
    it("resolve nomes em batch, ignora ids inválidos e usa pseudónimo sem email", async () => {
        const profileModel = {
        ...
        const names = await service.resolvePublicDisplayNames([
        ...
        expect(names).toEqual(new Map([
            ["507f1f77bcf86cd799439012", "Leonor Martins"],
            ["507f1f77bcf86cd799439013", "Aluno 9013"],
        ]));
