...
export class MaterialVersionsService {
     ...
     *
     * @param role role necessário para executar role error sem depender de estado global.
     ...
     *
     * @param version version necessário para executar to view sem depender de estado global.
