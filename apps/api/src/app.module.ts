...
import { ClassLearningActivityModule } from "./modules/class-learning-activity/class-learning-activity.module.js";
...
import { TeacherDashboardModule } from "./modules/teacher-dashboard/teacher-dashboard.module.js";
import { TeacherStudentChatModule } from "./modules/teacher-student-chat/teacher-student-chat.module.js";
...
import { PersistenceIntegrityModule } from "./common/persistence/persistence-integrity.module.js";
import { loadRuntimeConfig } from "./common/config/runtime-config.js";
import { StudentExperienceModule } from "./modules/student-experience/student-experience.module.js";
import { StudentAiAssistantModule } from "./modules/student-ai-assistant/student-ai-assistant.module.js";
...
@Module({
    imports: [
        MongooseModule.forRoot(
            runtimeConfig.mongoUri,
            {
                // PersistenceIntegrityService e a única autoridade de criação de
                // índices. Evita que o autoIndex do Mongoose concorra com o gate
                // explícito durante o arranque da aplicação.
                autoIndex: false,
            },
        ),
        HealthModule,
        ...
        StudyAlertsModule,
        StudentExperienceModule,
        StudentAiAssistantModule,
        AdminUsersModule,
        AuditLogModule,
