...
export const TECHNICAL_MAP: TechnicalMap = {
    modules: [
        ...
        },
        {
            ...
            responsibility:
                "Materiais privados TOPIC, URL, PDF, DOCX e MARKDOWN; Markdown vive em MongoDB com revisao otimista e os binarios mantem storage local atomico.",
            securityRule:
                "Ownership vem da sessao; Markdown rejeita HTML raw e URLs inseguras, enquanto metadata e quota binaria sao validadas antes de staging e promocao por rename.",
            critical: true,
        },
        {
        ...
        {
            name: "StudentExperienceModule",
            domain: "Experiencia do aluno",
            responsibility:
                "Agrega Hoje, continuidade, overview de disciplina e pesquisa contextual.",
            securityRule:
                "A sessao define o aluno; targetPath e jobs sao resolvidos no backend e cada contexto revalida ownership ou membership.",
            critical: true,
        },
        {
            name: "StudentAiAssistantModule",
            domain: "Assistente de estudo",
            responsibility:
                "Organiza conversas, forks consentidos e materiais privados transversais por contexto.",
            securityRule:
                "Ownership vem sempre da sessao; contexto, fontes, ultimos seis turnos e destino organizacional sao derivados e revalidados no backend.",
            critical: true,
        },
        {
            name: "ClassesModule",
        ...
        },
        {
            ...
            responsibility:
                "Salas, partilhas, snapshots Markdown privados e IA partilhada da sala.",
            securityRule:
                "Membership e fontes autorizadas sao validadas; Markdown privado entra apenas por snapshot explicito e nunca acompanha edicoes posteriores.",
            critical: true,
        },
        {
            ...
            responsibility:
                "Conversa aluno-aluno em tempo real, notas REST e cursores pessoais de leitura dentro de grupos baseados em StudyRoom.",
            securityRule:
                "Apenas STUDENT membros entram; sessao e membership sao revalidadas em join, send e antes de cada broadcast, com idempotencia e rate limit persistidos.",
            critical: true,
        },
        {
            name: "AiModule",
        ...
        },
        {
            ...
            responsibility:
                "Materiais TEXT, URL, PDF, DOCX e MARKDOWN associados a disciplina; Markdown usa rascunho, publicacao e revisao otimista.",
            securityRule:
                "Professor, disciplina e membership sao validados; rascunhos Markdown nunca chegam a alunos ou IA e downloads permanecem protegidos.",
            critical: true,
        },
        {
        ...
        },
        {
            ...
            responsibility:
                "Salas docentes por turma com disciplina opcional e referencias vivas a materiais oficiais publicados.",
            securityRule:
                "Valida turma/professor/aluno; apenas materiais publicados e selecionados da disciplina alimentam a IA guiada.",
            critical: true,
        },
        {
        ...
        },
        {
            ...
            domain: "Quotas IA",
            responsibility:
                "Reserva e consumo de quotas por aluno, turma ou grupo, com defaults internos para a demo.",
            securityRule:
                "Politica especifica prevalece; defaults nunca agregam consumo e todos os limites sao aplicados antes do provider.",
            critical: true,
        },
        {
            name: "AuditLogModule",
    ...
    routes: [
        {
            ...
            profile: "Aluno",
            securityRule:
                "A API agrega prioridades e continuidade autorizada sem aceitar targetPath do cliente.",
        },
        {
            path: "/app/estudar",
            ...
            profile: "Aluno",
            securityRule:
                "Turmas e areas privadas continuam separadas por membership e ownership no backend.",
        },
        {
            path: "/app/estudar/materiais/:artifactId?",
            page: "StudentStudyMaterialsPage + StudentStudyMaterialDetailPage",
            profile: "Aluno",
            securityRule:
                "O arquivo filtra sempre por userId; disciplina, turma e area sao apenas organizacao e o estado arquivado bloqueia novas tentativas.",
        },
        {
            path: "/app/em-grupo",
            page: "StudentGroupHubPage",
            profile: "Aluno",
            securityRule:
                "Salas guiadas, grupos e salas partilhadas preservam os services e validacoes de membership existentes.",
        },
        {
            path: "/app/plano",
            ...
            profile: "Aluno",
            securityRule:
                "Agenda, objetivos e historico usam exclusivamente o aluno da sessao.",
        },
        {
            path: "/app/assistente/:conversationId?",
            page: "StudentAssistantPage + StudentAssistantLauncher",
            profile: "Aluno",
            securityRule:
                "A API constroi labels e rotas, revalida ownership/membership e mantem cada conversa num contexto imutavel.",
        },
        {
            path: "/app/perfil",
            page: "ProfilePage",
        ...
        },
        {
            ...
            page: "LegacyRedirect -> StudentAssistantPage",
            profile: "Aluno",
            securityRule:
                "A pergunta nao envia ano; a API valida membership, fontes e perfil do aluno autenticado.",
        },
        {
            path: "/app/grupos/:groupId/:tab?",
            page: "StudentGroupWorkspacePage",
            profile: "Aluno",
            securityRule:
                "A rota fornece o contexto, mas a API revalida membership em mensagens e sessoes; o Assistente usa o launcher global.",
        },
        {
    ...
    endpoints: [
        {
            ...
            path: "/api/student/assistant/contexts|conversations|messages",
            input: "contexto canonico, conversa propria e pergunta sem IDs de fontes",
            output: "contextos seguros, conversas e turnos normalizados com citacoes",
            securityRule:
                "A fachada revalida o aluno e o contexto em cada mutacao, delega no executor governado e omite links quando o acesso terminou.",
        },
        {
            method: "GET/POST",
            path: "/api/student/assistant/conversations/:id/artifact-setup|artifact-targets|artifacts|artifact-jobs",
            input: "tipo, topico opcional e destino apenas quando o contexto colaborativo o exige",
            output: "preview minimizado, destinos ativos, material privado ou job recuperavel",
            securityRule:
                "O browser nunca escolhe fontes, turnos ou ownership; o servidor congela ate seis turnos e fontes atuais antes do executor governado.",
            interfaceGroup: "AI",
        },
        {
            method: "GET/POST/DELETE",
            path: "/api/student/study-materials/:artifactId?|:artifactId/export|:artifactId/quiz-attempts",
            input: "filtros organizacionais, formato de exportacao ou respostas do quiz",
            output: "arquivo privado, detalhe, ficheiro persistido ou resultado da tentativa",
            securityRule:
                "userId da sessao e a fronteira; export nao chama provider, delete e transacional e contextos terminados ficam read-only.",
            interfaceGroup: "AI",
        },
        {
            method: "POST",
        ...
        },
        {
            ...
            input: "cookie de sessao",
            output: "continuar, prioridades e contextos recentes",
            securityRule:
                "O backend agrega apenas recursos autorizados, ordena prioridades e constroi todos os targetPath.",
        },
        {
            method: "PUT",
            path: "/api/students/me/recent-context",
            input: "kind canonico e contextId",
            output: "acao segura do contexto",
            securityRule:
                "Ownership ou membership e revalidado; titulo, rota e metadata nunca sao aceites do cliente.",
        },
        {
            method: "GET",
            path: "/api/student/subjects/:subjectId/overview",
            input: "disciplina da rota",
            output: "identidade segura, contagens, material recente e proximo teste",
            securityRule:
                "Exige membership e omite teacherId, solucoes e metadata interna de indexacao.",
        },
        {
            method: "POST",
            path: "/api/student/search",
            input: "query e scope SUBJECT, STUDY_AREA ou ALL_STUDIES",
            output: "ate 20 excertos com targetPath seguro",
            securityRule:
                "Jobs DONE sao resolvidos no servidor, limitados a 50 e revalidados por ownership ou membership.",
        },
        {
            method: "POST/GET",
        ...
        },
        {
            ...
            securityRule:
                "SessionGuard e membership protegem leitura e compatibilidade REST; o frontend novo usa POST apenas para notas.",
            interfaceGroup: "CHAT",
        },
        {
            method: "GET/PUT",
            path: "/api/student/study-group-chat/unread e /api/study-groups/:groupId/messages/read",
            input: "sessao STUDENT e grupo autorizado",
            output: "contadores bulk ou cursor de leitura avancado",
            securityRule:
                "Unread conta apenas MESSAGE de outros membros, posteriores ao cursor e nao tombstoned; leitura exige membership atual.",
            interfaceGroup: "CHAT",
        },
        {
            method: "POST",
            path: "/api/study-groups/:groupId/members",
            input: "email de uma conta STUDENT",
            output: "grupo atualizado de forma idempotente",
            securityRule:
                "Apenas o owner autenticado pode adicionar; collaborationKind e politica owner-only nunca chegam do cliente.",
            interfaceGroup: "CHAT",
        },
        {
            method: "WS",
            path: "/study-group-chat",
            input: "`study-group-chat:join` e `study-group-chat:send` com UUID v4",
            output: "acks tipados e `study-group-chat:message`",
            securityRule:
                "Cookie `sf_sid`, Origin, role e membership sao revalidados; persiste antes de emitir e expulsa sockets passivas revogadas.",
            interfaceGroup: "CHAT",
        },
        {
            method: "WS",
    ...
    models: [
        ...
        {
            name: "StudentRecentContext",
            domain: "Continuidade do aluno",
            sensitiveData: "userId, tipo de contexto, contextId e lastOpenedAt",
            protectionRule:
                "Maximo de cinco referencias distintas; registry inclui export e eliminacao, e acessos revogados sao removidos ao resolver Hoje.",
        },
        {
            name: "SchoolClass",
            domain: "Turmas oficiais",
        ...
        {
            name: "AiArtifact",
            domain: "Materiais de estudo gerados",
            sensitiveData:
                "conteudo estruturado, fontes privadas, ownership, destino organizacional e proveniencia minimizada do snapshot",
            protectionRule:
                "userId autoriza; targetKind/targetId apenas organizam e sao revalidados para pratica, sem conceder acesso a professor ou colegas.",
        },
        {
            name: "StudentAiArtifactGenerationSnapshot",
            domain: "Geracao IA assincrona",
            sensitiveData:
                "fontes e ate seis pares pergunta/resposta congelados para um quiz",
            protectionRule:
                "Criado com o job na mesma transacao, filtrado por userId/conversationId, removido por TTL e incluido no registry RGPD.",
        },
        {
            name: "StudentAiConversation",
            domain: "Assistente de estudo",
            sensitiveData:
                "contexto, titulo, estado, atividade e leases efemeras de execucao",
            protectionRule:
                "Ownership e contexto sao revalidados em cada operacao; artefactos usam contexto imutavel e lease independente.",
        },
        {
            name: "StudyRoom",
            domain: "Salas de estudo",
        ...
        },
        {
            ...
            protectionRule:
                "Apenas STUDENT membros listam/criam; nomes sao resolvidos dinamicamente sem email; a eliminacao remove autor/texto e preserva tombstone.",
        },
        {
            name: "StudentStudyGroupChatReadState",
            domain: "Chat dos grupos de estudo",
            sensitiveData: "cursor de leitura por aluno e grupo",
            protectionRule:
                "Indice unico por aluno/grupo, visivel apenas ao proprio fluxo e eliminado com a conta ou com um grupo exclusivo.",
        },
        {
            name: "Material",
            domain: "Materiais privados",
        ...
        },
        {
            ...
            domain: "Geracao IA assincrona",
            sensitiveData: "aluno, destino privado, snapshot efemero, estado, lease e erro publico",
            protectionRule:
                "Processador idempotente; snapshot e job nascem transacionalmente, tres tentativas, backoff e erro sem prompt/resposta do provider.",
        },
        {
        ...
        {
            name: "AiQuotaDefaultPolicy",
            domain: "Quota IA",
            sensitiveData: "scope, finalidade, limite e origem tecnica da seed",
            protectionRule:
                "Nao contem targetId nem dados pessoais; serve apenas de fallback e nao acumula consumo.",
        },
        {
            name: "AiQuotaUsage",
            domain: "Quota IA",
    ...
    flows: [
        ...
        {
            name: "Material privado do Assistente",
            source: "ultimos seis turnos e fontes atuais de qualquer contexto suportado",
            target: "copia privada organizada por area, disciplina ou turma",
            controlledFailure:
                "sem turnos, destino revogado, snapshot excessivo, consentimento, policy, quota ou provider falham de forma controlada sem persistencia parcial.",
        },
        {
