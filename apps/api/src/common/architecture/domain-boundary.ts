...
const DOMAIN_BY_MODULE_PREFIX: ReadonlyArray<{
    ...
    { prefix: "./modules/student-ai-assistant/", domain: "AI" },
    { prefix: "./modules/ai-", domain: "AI" },
    ...
    { prefix: "./modules/teacher-dashboard/", domain: "TEACHER" },
    { prefix: "./modules/teacher-student-chat/", domain: "TEACHER" },
    { prefix: "./modules/class-", domain: "TEACHER" },
    { prefix: "./modules/students/", domain: "STUDENT" },
    { prefix: "./modules/student-experience/", domain: "STUDENT" },
