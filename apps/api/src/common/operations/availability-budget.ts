/**
 * Avalia o orçamento mensal de indisponibilidade aceite por RNF24.
 */
 ...
 * @returns Estado operacional pronto para evidence ou health-check.
 * @throws Error quando a métrica recebida é impossível ou enganadora.
 */
export function evaluateAvailabilityBudget(
    ...
    if (!Number.isFinite(downtimeMinutes) || downtimeMinutes < 0) {
        ...
        throw new Error("downtimeMinutes deve ser um numero positivo ou zero.");
    }
